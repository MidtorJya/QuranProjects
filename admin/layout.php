...
<head>
    ...
    <link rel="stylesheet" href="adminassets/css/skin.min.css">
</head>
              ...
              <ul class="nav navbar-nav">
                      ...
                      <ul class="menu">
                        <li><!-- start message -->
                          <a href="#">
                            <div class="pull-left">
                              <!-- User Image -->
                              <img src="adminassets/img/profile.jpeg" class="img-circle" alt="User Image">
                            </div>
                ...
                <li class="dropdown user user-menu">
                  ...
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                    ...
                    <img src="adminassets/img/profile.jpeg" class="user-image" alt="User Image">
        ...
        <aside class="main-sidebar">
          ...
          <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <li class="active"><a href="crud-user/index.php"><i class="fa fa-link"></i> <span>จัดการผู้ใช้</span></a></li>
              <li><a href="index.html"><i class="fa fa-link"></i> <span>จัดการคำแปลกุรอาน</span></a></li>
